    ...
    //문제1. 주사위 3개 던지기.
     ...
     public static void ex02() {
       ...
       while(true) {
         ...
         System.out.print("출금전 " + balance + "원, " + num + "회 출금액 " + withdraw + "원, 출금후 ");
     ...
     public static void ex03() {
       ...
       for(int i = 0; i < n; i++) {
         int randomNum = secureRandom.nextInt(9);
         code += Integer.toString(randomNum);
       }
     ...
     public static void ex04() {
       ...
       int guguDan1 = random.nextInt(9) + 1;
       int guguDan2 = random.nextInt(9) + 1;
       
       System.out.print(guguDan1 + "x" +  guguDan2);
       int correctAnswer = guguDan1 * guguDan2;
     ...
     public static void ex07() {
       ...
       for(int i = 0; i < number; i++) {
         int randomNumber1 = secureRandom.nextInt(26) + 65;
         int randomNumber2 = secureRandom.nextInt(26) + 97;
         int randomNumber3 = secureRandom.nextInt(10) + 48;
         int randomNumber4 = secureRandom.nextInt(3);
         
         char higher = (char)randomNumber1;
         char lower = (char)randomNumber2;
         char num = (char)randomNumber3;
         ...
         codeNo += code.get(randomNumber4);
       }
       System.out.println("생성된 " + number + "자리 인증번호는 " + codeNo + "입니다.");
     ...
     public static void ex08() {
       ...
       while(true) {
         ...
         if(randomNumber == number) {
           System.out.println("정답. 총 " + num + "번만에 성공.");
           break;
