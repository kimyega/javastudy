...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    // 1. 생성 모드 : 언제나 새로 만든다. (덮어 쓰기)     new FileWriter(file)
    // 2. 추가 모드 : 새로 만들거나 기존 파일에 추가한다. new FileWriter(file, true)
  ...
  public static void ex02() {
    ...
    try {
      ...
      bw.newLine();           // 줄 바꿈 메소드. BufferedWritter 클래스의 전용 메소드이다.
      bw.write(str2);
  ...
  public static void ex03() {
    ...
    try {
      ...
      // 출력(파일로 데이터 보내기)
      pw.println(str1);    // 문자열 str1의 인덱스 0부터 4글자만 출력
      pw.println(str2);
      ...
      if(pw != null) {
        pw.close();       // try 체크를 하지 않는 PrinterWriter 클래스의 close() 메소드
      }
    }
  }
