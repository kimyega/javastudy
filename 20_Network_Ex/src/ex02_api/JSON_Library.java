...
public class JSON_Library {
  ...
  public static void ex01() {
    ...
    // JSON 객체 만들기
    JSONObject obj = new JSONObject();  // Map 기반
    obj.put("name", "tom");
    obj.put("age", 50);
  ...
  public static void ex03() {
    ...
    String name = obj.getString("name");  // String name = (String)obj.get("name"); 되긴하는데 비추
  ...
  public static void ex06() {
    ...
    JSONArray arr = new JSONArray(person);
